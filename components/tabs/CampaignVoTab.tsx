...
const CampaignVoTab: React.FC<CampaignVoTabProps> = ({ brandGuidelines, onAddAudioFile, textModel }) => {
    ...
    const handleGenerateScript = async () => {
        ...
        setError(null);
        try {
            const result = await generateVoScript(scriptGuideState.prompt, brandGuidelines, textModel);
