...
const AdEditorTab: React.FC<AdEditorTabProps> = ({ adEditorState, setAdEditorState, onApplyEdit }) => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const resultUrls = await generateAdImages(prompt, [annotatedImageInput], 1);
